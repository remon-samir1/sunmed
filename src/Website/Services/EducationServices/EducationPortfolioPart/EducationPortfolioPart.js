...
const EducationPortfolioPart = () => {
  ...
  return (
    <div className="DigitalMarketingLandingPortfolioPart">
            ...
            <SwiperSlide key={index}>
              <div className="work">
                <div className="details">
                  ...
                  <Link to={`/portfolio/education/details/${work.id}`} className="icon-container">
                    <Icon
      ...
      <Link to='/portfolio/tranning-platforms' className="normal-btn !rounded-none">
        SEE OUR PORTFOLIO
      </Link>
      </div>
    </div>
...
export default EducationPortfolioPart;
