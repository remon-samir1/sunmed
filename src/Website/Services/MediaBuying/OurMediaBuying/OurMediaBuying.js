  ...
  return (
    <div className="StartProject px-[7vw] py-7 !flex-row">
      <div className="content" ref={contentRef}>
        <p className="py-3 fz-[1.1rem]">MEDIA BUYING SERVICES</p>
      ...
      <div className="img">
        <img src={require("../../../../Images/media-buying-about.png")} alt="media buying" loading="lazy" />
      </div>
    </div>
  );
};

export default OurMediaBuying;
