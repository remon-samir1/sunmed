...
import "./PostProducationHero.css";

import { useGSAP } from "@gsap/react";
import Header from "../../../../../../../../Components/Header/Header";


const PostProducationHero = () => {
  ...
  return (
    <div className="HeroSection PostProducationHero">
   <Header/>
      <div className="content">
        <h1  ref={titleRef}>POST PRODUCATION</h1>
...
export default PostProducationHero;
