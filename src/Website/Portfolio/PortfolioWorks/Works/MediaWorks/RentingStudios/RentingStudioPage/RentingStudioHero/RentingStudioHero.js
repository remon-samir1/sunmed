...
import "./RentingStudioHero.css";

import { useGSAP } from "@gsap/react";
import Header from "../../../../../../../../Components/Header/Header";


const RentingStudioHero = () => {
  ...
  return (
    <div className="HeroSection RentingStudioHero">
   <Header/>
      <div className="content">
        <h1 className="uppercase"  ref={titleRef}>Renting company studios</h1>
...
export default RentingStudioHero;
