...
import "./MediaBuyingServHero.css";
import { Link } from "react-router-dom";
import { useGSAP } from "@gsap/react";
import Header from "../../../../../../../../Components/Header/Header";

const MediaBuyingServHero = () => {
  ...
  return (
    <div className="HeroSection MediaBuyingServHero">
      <Header />
      <div className="content">
        <h1 ref={titleRef}>MEDIA BUYING SERVICES</h1>

        <p className="md:w-[75%]" ref={paragraphRef}>
...
export default MediaBuyingServHero;
