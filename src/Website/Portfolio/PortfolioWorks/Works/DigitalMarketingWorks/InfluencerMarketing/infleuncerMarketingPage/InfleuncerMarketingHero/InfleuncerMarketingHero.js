...
const InfleuncerMarketingHero = () => {
  ...
  return (
    <div className="HeroSection SocialMediaServHero">
      <Header />
      <div className="content">
        <h1 ref={titleRef}>INFLUENCER MARKETING</h1>
...
export default InfleuncerMarketingHero;
