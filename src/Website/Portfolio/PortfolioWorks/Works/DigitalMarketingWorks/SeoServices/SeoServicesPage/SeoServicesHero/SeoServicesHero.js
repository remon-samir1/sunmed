...
import "./SeoServicesHero.css";
import { Link } from "react-router-dom";
import { useGSAP } from "@gsap/react";
import Header from "../../../../../../../../Components/Header/Header";

const SeoServicesHero = () => {
  ...
  return (
    <div className="HeroSection SeoServicesHero">
      <Header />
      <div className="content">
        <h1 className="uppercase" ref={titleRef}>
          SEO service
        </h1>
...
export default SeoServicesHero;
