...
const TranningBagsHero = () => {
  ...
  return (
    <div className="HeroSection TranningBagsHero">
   <Header/>
      <div className="content">
        <h1 className="uppercase"  ref={titleRef}>Preparing training bags</h1>
...
export default TranningBagsHero;
