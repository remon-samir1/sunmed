...
import "./VirtualProjectHero.css";
import { Link } from "react-router-dom";
import { useGSAP } from "@gsap/react";
import Header from "../../../../../../../../Components/Header/Header";

const VirtualProjectHero = () => {
  ...
  return (
    <div className="HeroSection VirtualProjectHero">
   <Header/>
      <div className="content">
        <h1 className="uppercase"  ref={titleRef}>virtual project </h1>
...
export default VirtualProjectHero;
