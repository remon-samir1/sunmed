...
import "./ElectronicMarketingHero.css";
...
const ElectronicMarketingHero = () => {
  ...
  return (
    <div className="HeroSection ElectronicMarketingHero">
   <Header/>
      <div className="content">
        <h1 className="uppercase"  ref={titleRef}>Electronic MARKETING</h1>
...
export default ElectronicMarketingHero;
