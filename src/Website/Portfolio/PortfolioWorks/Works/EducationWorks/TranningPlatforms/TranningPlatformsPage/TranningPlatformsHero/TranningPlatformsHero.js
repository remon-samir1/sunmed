...
import "./TranningPlatformsHero.css";

import { useGSAP } from "@gsap/react";
import Header from "../../../../../../../../Components/Header/Header";


const TranningPlatformsHero = () => {
  ...
  return (
    <div className="HeroSection TranningPlatformsHero">
   <Header/>
      <div className="content">
        <h1 className="uppercase"  ref={titleRef}>management of Tranning Platforms </h1>
...
export default TranningPlatformsHero;
