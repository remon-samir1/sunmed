...
import "./SocialMediaServDetailsHero.css";
import { Link } from "react-router-dom";
import { useGSAP } from "@gsap/react";
import Header from "../../../../../Components/Header/Header";

const SocialMediaServDetailsHero = () => {
  const [coords1, setCoords1] = useState({ x: 10, y: 0 });
  const [coords2, setCoords2] = useState({ x: 10, y: 0 });
 const textP = 'Digital marketing > Details'
  ...
  return (
    <div className="HeroSection SocialMediaServDetailsHero">
   <Header/>
...
export default SocialMediaServDetailsHero;
