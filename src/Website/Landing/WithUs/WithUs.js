          ...
          <div className="flex-1">
            <div className="texts">
              ...
              <p className="mt-2">
                ...
                together a free proposal, just fill out the form below or give us
            ...
            <form>
              <div className="flex gap-8 mt-8 items-center md:flex-row flex-col">
                <div className="input-field" ref={el => formElementsRef.current[0] = el}>
                  <input type="text" placeholder="What’s your name? *" />
                </div>
                <div className="input-field" ref={el => formElementsRef.current[1] = el}>
                  <input type="text" placeholder="Your company ( if applicable )" />
                </div>
              </div>
              <div className="flex gap-8 mt-8 items-center md:flex-row flex-col">
                <div className="input-field" ref={el => formElementsRef.current[2] = el}>
                  <input type="email" placeholder="Enter your email *" />
                </div>
                <div className="input-field" ref={el => formElementsRef.current[3] = el}>
                  <input type="number" placeholder="Enter your phone number *" />
                </div>
              </div>
              <div className="textarae-field" ref={el => formElementsRef.current[4] = el}>
                <textarea className="mt-8 h-32" placeholder="Enter your message here... " />
              </div>
              <div className="form-control" ref={el => formElementsRef.current[5] = el}>
              ...
              <p className="privacy" ref={el => formElementsRef.current[6] = el}>
                This form collects your contact information so that we can correspond with you. 
                Check out our <span>privacy policy</span> for more information about how we protect and manage your data
              </p>
              <Link className="link" ref={el => formElementsRef.current[7] = el}>SEND YOUR ENQUIRY</Link>
            </form>
          </div>

          <div className="tels" ref={telsRef}>
            <p>Tel: <span>(+966) 535338760</span></p>
            <p>Tel: <span>(+966) 535338760</span></p>
            <p>Email: <span>info@sunmedmediaproduction.com</span></p>
          </div>
        </div>
      </div>
    </div>
