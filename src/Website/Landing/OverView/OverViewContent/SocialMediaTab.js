    ...
    <div className="WebDevelopment">
      <div className="svg">
        <div className="flex flex-col items-start">
          ...
          <h5>Socila media services</h5>
          <div className="w-[80vw] md:w-[35vw] mt-[5vh]">

          <img className="w-full h-full object-cover" src={require('../../../../Images/social-media.png')} alt="web" loading="lazy" />
          </div>
        </div>
      </div>
      <div className="content">
        ...
        <Link className="link" to='/social-media'>Social media</Link>
